    ...
    <div class="card-body">
      ...
      <div class="row g-3">
        <div class="col-md-3">
          ...
          <img id="foto-preview"
            src="<?php echo !empty($gerente['foto']) ? UPLOAD_URL . $gerente['foto'] : ''; ?>"
      ...
      <div class="row g-3">
        ...
        <div class="col-md-3">
          ...
          <input type="text" class="form-control" id="celular" name="gerentes[celular]" maxlength="13"
            value="<?= htmlspecialchars($gerente['celular'] ?? ''); ?>">
        </div>
        ...
        <div class="col-md-3">
          ...
          <input type="text" class="form-control" id="ie" name="gerentes[ie]" maxlength="15"
            value="<?= htmlspecialchars($gerente['ie'] ?? ''); ?>">
        </div>
        ...
        <div class="col-md-3">
          ...
          <input type="text" class="form-control" id="depto" name="gerentes[depto]" maxlength="100"
            value="<?= htmlspecialchars($gerente['depto'] ?? ''); ?>">
        </div>
